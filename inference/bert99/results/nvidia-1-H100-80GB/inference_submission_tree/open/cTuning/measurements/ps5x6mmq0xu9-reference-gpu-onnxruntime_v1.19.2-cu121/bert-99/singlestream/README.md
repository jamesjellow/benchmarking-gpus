...
* OS version: Linux-6.2.0-37-generic-x86_64-with-glibc2.35
* CPU version: x86_64
...
Platform: ps5x6mmq0xu9-reference-gpu-onnxruntime_v1.19.2-cu121

Model Precision: fp32

### Accuracy Results 
`F1`: `90.88233`, Required accuracy for closed division `>= 89.96526`

### Performance Results 
`90th percentile latency (ns)`: `4683671.0`
